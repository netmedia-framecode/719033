...
$_SESSION["project_sistem_penerimaan_blt"]["name_page"] = "Sub Menu Access";
    ...
    <div class="page-header-right ms-auto">
      <div class="page-header-right-items">
        ...
        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
          <a href="add-sub-menu-access" class="btn btn-primary">
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable">
                ...
                <tbody>
                  <?php foreach ($views_user_access_sub_menu as $key => $data) { ?>
                  <tr class="single-item">
                    <td class="text-center"><?= $key + 1 ?></td>
                    <td><?= $data['role'] ?></td>
                    <td><?= $data['menu'].' / '.$data['title'] ?></td>
                    <td>
                      <div class="hstack gap-2 justify-content-center">
                        <form action="" method="post">
                          <input type="hidden" name="id_access_sub_menu" value="<?= $data['id_access_sub_menu'] ?>">
                          <input type="hidden" name="title" value="<?= $data['title'] ?>">
                          <button type="submit" name="delete_sub_menu_access" class="btn btn-danger btn-sm">
