...
if (!isset($_GET["p"])) {
  ...
  $pull_data = "SELECT * FROM prosedur_seleksi WHERE id = '$id'";
  $store_data = mysqli_query($conn, $pull_data);
  $view_data = mysqli_fetch_assoc($store_data);
  $_SESSION["project_sistem_penerimaan_blt"]["name_page"] = "Ubah Prosedur Seleksi";
            ...
            <div class="card-body">
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="url" name="link_video" value="<?= $view_data['link_video'] ?>" class="form-control" id="link_video" placeholder="Link Video" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 hstack gap-2 justify-content-left">
                  ...
                  <button type="submit" name="edit_prosedur_seleksi" class="btn btn-warning">Ubah</button>
                </div>
              </form>
            </div>
          </div>
