...
$_SESSION["project_sistem_penerimaan_blt"]["name_page"] = "Sub Kriteria";
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable">
                ...
                <tbody>
                  <?php foreach ($views_sub_kriteria as $key => $data) { ?>
                    <tr class="single-item">
                      ...
                      <td>
                        <div class="hstack gap-2 justify-content-center">
                          <a href="edit-sub-kriteria?p=<?= $data['id'] ?>" class="btn btn-warning btn-sm">
                            <i class="bi bi-pencil-square"></i>
                          </a>
                          <form action="" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                            <input type="hidden" name="id" value="<?= $data['id'] ?>">
                            <input type="hidden" name="nama_sub_kriteria" value="<?= $data['nama_sub_kriteria'] ?>">
